...
export function FileUploadArea({ onUpload, loading = false, externalFiles = [], onExternalFilesProcessed }: FileUploadAreaProps) {
  ...
  return (
    <div className="bg-white rounded-3xl p-6 md:p-8 shadow-soft border-2 border-gray-100">
      ...
      >
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-600 mb-4">Klik atau Tarik File ke Sini!</p>
      ...
      <div className="mt-6">
        ...
        <input
          ...
          placeholder="A"
          disabled={loading}
          className="w-full h-12 px-4 rounded-xl border-2 border-gray-200 focus:border-black focus:outline-none transition-colors disabled:bg-gray-50 disabled:cursor-not-allowed"
        />
      </div>
      ...
      {selectedFiles.length > 0 && (
        <div className="mt-6">
          <h3 className="font-semibold mb-3">File yang Dipilih ({selectedFiles.length})</h3>
            ...
            {selectedFiles.map((preview, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Show checkmark when uploaded, X button when not */}
                  {preview.uploaded ? (
      ...
      {selectedFiles.length > 0 && (
        <div>
          ...
          {isUploading && (
            <div className="mt-6 mb-4 space-y-2 p-4 bg-blue-50 rounded-xl border-2 border-blue-200">
          ...
          disabled={loading || isUploading}
          className="w-full mt-6 h-12 bg-primary text-black font-bold rounded-xl hover:bg-primary/80 active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-[0_4px_12px_rgba(212,255,0,0.4)]"
        >
          {loading || isUploading ? (
            <>
