...
export const Translator: React.FC<TranslatorProps> = ({ onShowToast }) => {
  ...
  return (
    <div className="max-w-[1200px] mx-auto px-4 md:px-8 py-8">
      ...
      {!apiKey && (
        <div className="bg-white rounded-[24px] p-12 text-center shadow-[0_4px_16px_rgba(0,0,0,0.08)] border border-[#E5E5E5]">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#95E1D3] text-black font-medium rounded-[16px] hover:bg-[#81CABB] transition-colors"
          >
            Get Free API Key
          </a>
        </div>
      ...
      {/* Main Translator */}
      {apiKey && (
        <div className="bg-white rounded-[24px] p-6 md:p-8 shadow-[0_4px_16px_rgba(0,0,0,0.08)] border border-[#E5E5E5]">
          {/* Language Selection */}
          <div className="flex flex-col md:flex-row items-stretch md:items-end gap-4 mb-6">
            ...
            <button
              ...
              className={`
                md:mb-[26px] h-[48px] w-[48px] mx-auto md:mx-0 rounded-full flex items-center justify-center transition-all
                ${sourceLang === 'auto'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div className="relative">
              ...
              <div className="relative">
                <textarea
                  ...
                  className="w-full min-h-[200px] max-h-[400px] p-4 rounded-[16px] border border-[#E5E5E5] focus:border-[#95E1D3] focus:outline-none resize-none text-base leading-relaxed"
                  style={{ lineHeight: '1.6' }}
                  aria-label="Source text input"
                />
                <div
                  className="absolute bottom-3 right-3 text-[11px] font-medium px-2 py-1 rounded"
                  style={{
            ...
            <div className="relative">
              <div className="flex items-center justify-between mb-2">
                ...
                {targetText && (
                  <button
                    ...
                    className="text-xs text-[#95E1D3] hover:text-[#81CABB] font-medium transition-colors flex items-center gap-1"
              ...
              <textarea
                ...
                className="w-full min-h-[200px] max-h-[400px] p-4 rounded-[16px] border border-[#E5E5E5] bg-[#FAFAFA] resize-none text-base leading-relaxed cursor-default"
                style={{ lineHeight: '1.6' }}
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              ...
              className={`
                flex-1 h-[52px] rounded-[16px] font-medium text-base flex items-center justify-center gap-2 transition-all
                ${canTranslate
            ...
            <button
              ...
              className={`
                sm:w-[140px] h-[52px] rounded-[16px] font-medium text-base flex items-center justify-center gap-2 transition-all
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-start gap-3 p-4 bg-[#F5F5F5] rounded-[12px]">
